export const en = {
  ...
  store: {
    ...
    preview: {
      ...
      body: 'We are finishing the online payment setup. Leave us your email and we will write to you the day we open, before anyone else.',
      cartTitle: 'We can’t charge you yet.',
      cartBody: 'We saved your selection. Leave your email on any model and we will let you know as soon as payments open.',
    },
    waitlist: {
      titleSoldOut: 'Sold out for now.',
      bodySoldOut:
        'Every AXIS is a physical unit of our inventory. Leave us your email and we will let you know the moment units of this model come in.',
      emailLabel: 'Your email',
      emailPlaceholder: 'you@example.com',
      submit: 'Notify me',
      sending: 'Saving…',
      okTitle: 'Done, we will let you know.',
      okBody: 'We will write to {email} as soon as there are units.',
  ...
  admin: {
    ...
    waitlist: {
      ...
      empty: 'Nobody has left their email yet.',
      waiting: 'waiting',
      stock: 'Stock',
