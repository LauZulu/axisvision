export const en = {
  ...
  hero: {
    ...
    trust: ['Secure purchase', '6-month warranty', 'Home delivery'],
  },
  ...
  store: {
    ...
    buy: 'Buy',
    soon: 'Online purchase coming soon',
    reserve: 'Buy on WhatsApp',
    back: 'Back to store',
    gallery: 'Gallery',
    ...
    soldOut: 'Sold out',
    reserveMessage: 'Hi AXIS. I want to buy the {model}. Can you help me with prescription and shipping?',
    quantity: 'Quantity',
    buyNow: 'Buy now',
    ...
    preview: {
      badge: 'Available now',
      title: 'You can have yours today.',
      body: 'Online checkout is coming very soon. In the meantime, leave us your contact: we will message you on WhatsApp and complete your purchase together.',
      submit: 'I want to buy them',
      okTitle: 'Done, we will message you.',
      okBody: 'We will message you on WhatsApp and write to {email} to complete your purchase.',
      okBodyWhatsapp: 'We will message you on WhatsApp to complete your purchase.',
      privacy: 'We use your contact only to help you with your purchase. No marketing.',
      cartTitle: 'Online checkout is coming very soon.',
      cartBody: 'We saved your selection. Leave your contact on any model and we will message you on WhatsApp to complete your purchase.',
    },
    waitlist: {
  ...
  faq: {
    ...
    items: [
      { q: 'How do I buy AXIS?', a: 'Pick your model and leave us your contact, or message us on WhatsApp: we get in touch and complete the purchase with you. Online payment is coming very soon.' },
  ...
  contact: {
    ...
    note: 'Secure purchase · 6-month warranty · Home delivery',
    visitUs: 'Visit us',
    followUs: 'Follow us',
  },
  ...
  cart: {
    ...
    note: 'Shipping arranged after payment · Secure payment',
    prescriptionNote:
  ...
  checkout: {
    ...
    secureNote: 'Secure online payment. Cards, PSE, Nequi and more.',
  ...
  reserve: {
    eyebrow: 'Buy',
    title: 'Pick your AXIS and we’ll message you to complete the purchase.',
    intro: 'Tap the model you liked and leave us your WhatsApp. We message you, sort out lenses and prescription, and complete the purchase there.',
    step1: '1 · The model',
    step2: '2 · Your details',
    chosen: 'Your pick: {model}',
    ...
    submit: 'I want to buy them',
    sending: 'Sending…',
    okTitle: 'Done, we’ll message you.',
    okBody: 'We’ll message you on WhatsApp to complete the purchase of your {model}.',
    alreadyTitle: 'You were already on the list.',
    alreadyBody: 'That number was already down for the {model}. We’ll message you all the same.',
    whatsappNow: 'Message us now',
    whatsappMessage: 'Hi, I just left my details to buy the AXIS {model}.',
